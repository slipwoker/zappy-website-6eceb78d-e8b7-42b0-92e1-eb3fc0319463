    ...
    if (contactForm) {
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMessage.textContent = contactForm.getAttribute('data-success') || 'Thank you! Your message has been sent.';
        ...
        contactForm.addEventListener('input', function(e) {
            if (e.target.matches('input, textarea, select')) {
                if (e.target.closest('.form-group')?.querySelector('.form-error') || e.target.style.borderColor === 'rgb(229, 62, 62)') {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6eceb78d-e8b7-42b0-92e1-eb3fc0319463',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6eceb78d-e8b7-42b0-92e1-eb3fc0319463';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6eceb78d-e8b7-42b0-92e1-eb3fc0319463';
